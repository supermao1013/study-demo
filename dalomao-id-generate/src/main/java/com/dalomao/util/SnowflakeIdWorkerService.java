 ...
 *
 * 以上加起来刚好64位，为一个Long型。<br>
 * SnowFlake的优点是，整体上按照时间自增排序，并且整个分布式系统内不会产生ID碰撞(由数据中心ID和机器ID作区分)，并且效率较高，经测试，SnowFlake每秒能够产生26万ID左右。
 */
@Component("snowflakeIdWorkerService")
public class SnowflakeIdWorkerService {

    // ==============================Fields===========================================
    /** 开始时间戳 (2015-01-01凌晨零点)(单位毫秒，自己指定) */
     ...
     * 构造函数
     */
    public SnowflakeIdWorkerService() {
        this.workerId = 0L;
    ...
    public static void main(String[] args) {
        SnowflakeIdWorkerService idWorker = new SnowflakeIdWorkerService(0, 0);
