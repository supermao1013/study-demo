...
/**
 * 分页拦截器
 * 拦截StatementHandler.class中参数类型为{Connection.class, Integer.class}的prepare方法
 */
...
public class PageInterceptor implements Interceptor {
    ...
    /**
     * 我们的最终目的是修改BoundSql中的sql，所以就需要拿到被代理类中的BoundSql对象
     */
    @Override
    public Object intercept(Invocation invocation) throws Throwable {
         ...
         *  public Statement prepare(Connection connection, Integer transactionTimeout) throws SQLException {
            ...
            delegate对象就是PreparedStatementHandler对象，而PreparedStatementHandler对象中有一个BoundSql属性，所以我们第一步要获取PreparedStatementHandler
